...
public class Text3F
{
    ...
    public const string StudyF3D2Option = "Approach the large worn door, marked with the number 2.";
    public const string BedroomF3D3Option = "Approach the door that is standing ajar, marked with a 3.";
    public const string ClosetF3D4Option = "Approach the room at the end of the hallway, marked with a faded 4.";
