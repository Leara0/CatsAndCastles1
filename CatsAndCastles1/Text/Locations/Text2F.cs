...
public class Text2F
{
    ...
    public const string EnterRoomAfterKillingGuard =
        "You step back into what must be the guard's quarters. The body of your fallen opponent lies still. If you " +
        "left anything behind, it might still be there — or you could take the time to explore the rest of the room.\n";

    public const string ExploreGuardRoomF2R2 =
    ...
    public const string ExploreClosetF2R3 =
    ...
    public const string ExploreLibraryF2R4 =
